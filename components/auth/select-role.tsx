...
export function SelectRole({ onRoleSelect, isModal = false }: SelectRoleProps) {
  ...
  return (
    <div className={isModal ? "" : "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center"}>
      <div className={`${isModal ? "" : "container max-w-4xl mx-auto"} px-4`}>
        {!isModal && (
